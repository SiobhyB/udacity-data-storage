...
public class EditorActivity extends AppCompatActivity implements
    ...
    /** EditText field to enter the book's supplier's number */
    private EditText mSupplierNumberEditText;

    /** Button to contact supplier */
    private Button mSupplierContactButton;
    ...
    /** Variables for adding and subtracting quantity*/
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSupplierContactButton = findViewById(R.id.action_contact_supplier);

        mSupplierContactButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent supplierNumberIntent = new Intent(Intent.ACTION_DIAL);
                supplierNumberIntent.setData(Uri.parse("tel:" + mSupplierNumberEditText));
    ...
    private void saveBook() {
        ...
        String suppliertNumberString = mSupplierNumberEditText.getText().toString().trim();
        ...
        if (mCurrentBookUri == null &&
                (TextUtils.isEmpty(nameString) && TextUtils.isEmpty(priceString) &&
                        ...
                        && TextUtils.isEmpty(suppliertNumberString))) {
            return;
        }

        if (TextUtils.isEmpty(nameString) ) {
            Toast.makeText(this, getString(R.string.editor_insert_book_name_empty),
                    Toast.LENGTH_SHORT).show();
            return;
        }

        if (TextUtils.isEmpty(priceString) ) {
            Toast.makeText(this, getString(R.string.editor_insert_book_price_empty),
                    Toast.LENGTH_SHORT).show();
            return;
        }

        if (TextUtils.isEmpty(quantityString) ) {
            Toast.makeText(this, getString(R.string.editor_insert_book_quantity_empty),
                    Toast.LENGTH_SHORT).show();
            return;
        }

        if (TextUtils.isEmpty(supplierString) ) {
            Toast.makeText(this, getString(R.string.editor_insert_book_supplier_empty),
                    Toast.LENGTH_SHORT).show();
            return;
        }

        if (TextUtils.isEmpty(supplierString) ) {
            Toast.makeText(this, getString(R.string.editor_insert_book_supplier_number_empty),
                    Toast.LENGTH_SHORT).show();
            return;
        }
        ...
        values.put(BookEntry.COLUMN_BOOK_SUPPLIER_NUMBER, suppliertNumberString);
