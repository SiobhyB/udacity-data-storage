...
import com.example.android.booktracking.BookCursorAdapter;
...
public class InventoryActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor>{
    ...
    private void insertBook() {
        ...
        // and Harry Potter's attributes are the values.
        ...
        values.put(BookEntry.COLUMN_BOOK_SUPPLIER_NAME, "Bloomsbury");
        values.put(BookEntry.COLUMN_BOOK_SUPPLIER_NUMBER, 202002);
